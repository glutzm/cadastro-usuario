...
public interface UserApiControllerDoc {
    ...
    @ApiPageable
    CollectionModel<EntityModel<User>> searchAll(@ApiIgnore Pageable pageable);
    ...
    EntityModel<User> searchById(Long id);
    ...
    EntityModel<User> insert(UserDTO userDTO);
    ...
    EntityModel<User> update(UserDTO userDTO, Long id);
    ...
    EntityModel<User> changeAvailability(Long id);
